...
import NoticeFormModal1 from '@/guide/dev/modal/NoticeFormModal1';
...
/* 목록+폼모달(store + list선택연동) */
function GuidePatternListWidthFormModalCase1() {
    ...
    <>
      <main className="content-main">
        ...
        <NoticeFormModal1
          ...
          formInfo={listSelectedInfo}
        />
      </main>
    </>
  );
}
export default GuidePatternListWidthFormModalCase1;
